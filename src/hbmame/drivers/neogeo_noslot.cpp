...
ROM_START( dragonsh ) //Official Roms Modified
	ROM_REGION( 0x100000, "maincpu", 0 )
...
GAME( 1999, kof99knv,   kof99,    neogeo_noslot,   neogeo,    neogeo_state,    init_kof99,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release)(Ver.new)" , MACHINE_SUPPORTS_SAVE ) /* Encrypted Code & GFX */
