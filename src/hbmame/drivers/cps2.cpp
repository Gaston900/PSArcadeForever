...
static INPUT_PORTS_START( cps2_4p2b )
	...
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(1)
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(1)
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(1) PORT_NAME("P1 Button1 Attack") PORT_CONDITION("IN0", 0x0030, NOTEQUALS, 0x0010)
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(1) PORT_NAME("P1 Button2 Jump") PORT_CONDITION("IN0", 0x0030, NOTEQUALS, 0x0020)		
	PORT_BIT( 0x0030, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(1) PORT_NAME("P1 Button1 + Button2 Mega Crash") PORT_CONDITION("IN0", 0x0030, EQUALS, 0x0030)
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(1) */
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(2) PORT_NAME("P2 Button1 Attack") PORT_CONDITION("IN0", 0x3000, NOTEQUALS, 0x1000)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(2) PORT_NAME("P2 Button2 Jump") PORT_CONDITION("IN0", 0x3000, NOTEQUALS, 0x2000)		
	PORT_BIT( 0x3000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2) PORT_NAME("P2 Button1 + Button2 Mega Crash") PORT_CONDITION("IN0", 0x3000, EQUALS, 0x3000)
    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(2) */
	...
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(3)
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(3)
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(3) PORT_NAME("P3 Button1 Attack") PORT_CONDITION("IN1", 0x0030, NOTEQUALS, 0x0010)
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(3) PORT_NAME("P3 Button2 Jump") PORT_CONDITION("IN1", 0x0030, NOTEQUALS, 0x0020)		
	PORT_BIT( 0x0030, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(3) PORT_NAME("P3 Button1 + Button2 Mega Crash") PORT_CONDITION("IN1", 0x0030, EQUALS, 0x0030)
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(3) */
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(4) PORT_NAME("P4 Button1 Attack") PORT_CONDITION("IN1", 0x3000, NOTEQUALS, 0x1000)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(4) PORT_NAME("P4 Button2 Jump") PORT_CONDITION("IN1", 0x3000, NOTEQUALS, 0x2000)		
	PORT_BIT( 0x3000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(4) PORT_NAME("P4 Button1 + Button2 Mega Crash") PORT_CONDITION("IN1", 0x3000, EQUALS, 0x3000)
    PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(4) */
...
static INPUT_PORTS_START( cps2_3p3b )
	...
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(1) */
	PORT_BIT( 0x0010+0x0020, IP_ACTIVE_LOW, IPT_BUTTON_AB ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button2)") PORT_CONDITION("IN0", 0x0070, NOTEQUALS, 0x0030)	
	PORT_BIT( 0x0020+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button2 + Button3)") PORT_CONDITION("IN0", 0x0070, NOTEQUALS, 0x0060)
	PORT_BIT( 0x0010+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button3)") PORT_CONDITION("IN0", 0x0070, NOTEQUALS, 0x0050)
	PORT_BIT( 0x0010+0x0020+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_ABC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button2 + Button3)") PORT_CONDITION("IN0", 0x0070, NOTEQUALS, 0x0070)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(2)
	...
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(2) */
	PORT_BIT( 0x1000+0x2000, IP_ACTIVE_LOW, IPT_BUTTON_AB ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button2)") PORT_CONDITION("IN0", 0x7000, NOTEQUALS, 0x3000)
	PORT_BIT( 0x2000+0x4000, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button2 + Button3)") PORT_CONDITION("IN0", 0x7000, NOTEQUALS, 0x6000)
	PORT_BIT( 0x1000+0x4000, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button3)") PORT_CONDITION("IN0", 0x7000, NOTEQUALS, 0x5000)
	PORT_BIT( 0x1000+0x2000+0x4000, IP_ACTIVE_LOW, IPT_BUTTON_ABC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button2 + Button3)") PORT_CONDITION("IN0", 0x7000, NOTEQUALS, 0x7000)	
	...
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED )           /* BUTTON4 PORT_PLAYER(3) */
	PORT_BIT( 0x0010+0x0020, IP_ACTIVE_LOW, IPT_BUTTON_AB ) PORT_PLAYER(3) PORT_NAME("P3 Button Combokey (Button1 + Button2)") PORT_CONDITION("IN1", 0x0070, NOTEQUALS, 0x0030)
	PORT_BIT( 0x0020+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(3) PORT_NAME("P3 Button Combokey (Button2 + Button3)") PORT_CONDITION("IN1", 0x0070, NOTEQUALS, 0x0060)
	PORT_BIT( 0x0010+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(3) PORT_NAME("P3 Button Combokey (Button1 + Button3)") PORT_CONDITION("IN1", 0x0070, NOTEQUALS, 0x0050)
	PORT_BIT( 0x0010+0x0020+0x0040, IP_ACTIVE_LOW, IPT_BUTTON_ABC ) PORT_PLAYER(3) PORT_NAME("P3 Button Combokey (Button1 + Button2 + Button3)") PORT_CONDITION("IN1", 0x0070, NOTEQUALS, 0x0070)	
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(4)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(4)
...
static INPUT_PORTS_START( cybots )
	...
	PORT_BIT( 0x0030, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button2)") PORT_CONDITION("IN0", 0x0030, NOTEQUALS, 0x0030)
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(1)
	...
	PORT_BIT( 0x3000, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button2)") PORT_CONDITION("IN0", 0x3000, NOTEQUALS, 0x3000)
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2)
