...
public:
	...
	void mslug5b_vx_decrypt(u8* ymsndrom, u32 ymsndrom_size);
	void mslug5b_cx_decrypt(u8* sprrom, u32 sprrom_size);
...
public:
	...
	void mslug3a_bankswitch_w(u16 data);
	...
	void mslug3a_install_protection(cpu_device* maincpu, neogeo_banked_cart_device* bankdev);
