...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_HISTORY_PATH,                  "support/history;dats;.",      core_options::option_type::STRING,  "path to system/software info files" },
	{ OPTION_CATEGORYINI_PATH,              "support/folders",             core_options::option_type::STRING,  "path to category ini files" },
	{ OPTION_CABINETS_PATH,                 "support/cabinets;cabdevs",    core_options::option_type::STRING,  "path to cabinets / devices image" },
	{ OPTION_CPANELS_PATH,                  "support/cpanel",              core_options::option_type::STRING,  "path to control panel image" },
	{ OPTION_PCBS_PATH,                     "support/pcb",                 core_options::option_type::STRING,  "path to pcbs image" },
	{ OPTION_FLYERS_PATH,                   "support/flyers",              core_options::option_type::STRING,  "path to flyers image" },
	{ OPTION_TITLES_PATH,                   "support/titles",              core_options::option_type::STRING,  "path to titles image" },
	{ OPTION_ENDS_PATH,                     "support/ends",                core_options::option_type::STRING,  "path to ends image" },
	{ OPTION_MARQUEES_PATH,                 "support/marquees",            core_options::option_type::STRING,  "path to marquees image" },
	{ OPTION_ARTPREV_PATH,                  "support/artpreview",          core_options::option_type::STRING,  "path to artwork preview image" },
	{ OPTION_BOSSES_PATH,                   "support/bosses",              core_options::option_type::STRING,  "path to bosses image" },
	{ OPTION_LOGOS_PATH,                    "support/logo",                core_options::option_type::STRING,  "path to logos image" },
	{ OPTION_SCORES_PATH,                   "support/scores",              core_options::option_type::STRING,  "path to scores image" },
	{ OPTION_VERSUS_PATH,                   "support/versus",              core_options::option_type::STRING,  "path to versus image" },
	{ OPTION_GAMEOVER_PATH,                 "support/gameover",            core_options::option_type::STRING,  "path to gameover image" },
	{ OPTION_HOWTO_PATH,                    "support/howto",               core_options::option_type::STRING,  "path to howto image" },
	{ OPTION_SELECT_PATH,                   "support/select",              core_options::option_type::STRING,  "path to select image" },
	{ OPTION_ICONS_PATH,                    "support/icons",               core_options::option_type::STRING,  "path to ICOns image" },
	{ OPTION_COVER_PATH,                    "support/covers",              core_options::option_type::STRING,  "path to software cover image" },
	{ OPTION_UI_PATH,                       "config/ui",                   core_options::option_type::STRING,  "path to UI files" },
	...
	{ OPTION_FORCED4X3,                     "0",        core_options::option_type::BOOLEAN,     "force the appearance of the snapshot in the list software to 4:3" },
	{ OPTION_USE_BACKGROUND,                "1",        core_options::option_type::BOOLEAN,     "enable background image in main view" },
	{ OPTION_SKIP_BIOS_MENU,                "1",        core_options::option_type::BOOLEAN,     "skip bios submenu, start with configured or default" },
	...
	{ OPTION_UI_BORDER_COLOR,               "ffb41010",     core_options::option_type::STRING,      "UI border color (ARGB)" },
	{ OPTION_UI_BACKGROUND_COLOR,           "ef161616",     core_options::option_type::STRING,      "UI background color (ARGB)" },
	{ OPTION_UI_CLONE_COLOR,                "ffc6c6c6",     core_options::option_type::STRING,      "UI clone color (ARGB)" },
	...
	{ OPTION_UI_SLIDER_COLOR,               "efffffff",     core_options::option_type::STRING,      "UI slider color (ARGB)" },
	{ OPTION_UI_SUBITEM_COLOR,              "efffffff",     core_options::option_type::STRING,      "UI subitem color (ARGB)" },
