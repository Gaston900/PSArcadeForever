...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_UI_BACKGROUND_COLOR,           "ef161616",     OPTION_STRING,      "UI background color (ARGB)" },
	{ OPTION_UI_CLONE_COLOR,                "ffc6c6c6",     OPTION_STRING,      "UI clone color (ARGB)" },
	...
	{ OPTION_UI_SLIDER_COLOR,               "efffffff",     OPTION_STRING,      "UI slider color (ARGB)" },
	{ OPTION_UI_SUBITEM_COLOR,              "efffffff",     OPTION_STRING,      "UI subitem color (ARGB)" },
