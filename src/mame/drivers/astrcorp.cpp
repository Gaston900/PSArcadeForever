...
ROM_START( magibombd )
	...
	ROM_REGION16_BE( 0x02, "astro_cpucode", 0 )
...
ROM_START( magibombg )
	...
	ROM_REGION16_BE( 0x02, "astro_cpucode", ROMREGION_ERASE00 )
...
GAME( 2001?, magibombh, magibomb, magibombb, magibomb, magibomb_state,  init_magibomb,  ROT0, "Astro Corp.",        "Magic Bomb (Ver. A4.0A)",            MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 2001?, magibombi, magibomb, magibombb, magibomb, magibomb_state,  init_magibomb,  ROT0, "Astro Corp.",        "Magic Bomb (Ver. A3.6A)",            MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )

// Heavier encryption
GAME( 2004,  zoo,       0,        magibombd, skilldrp, astoneage_state, init_zulu,      ROT0, "Astro Corp.",        "Zulu (Ver. ZO.02.D)",                MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE ) // 10:53:44 Aug 27 2004
...
//GAME( 2004,  magibombg, magibomb, magibombg, magibombg,zoo_state,       init_magibombg, ROT0, "Astro Corp.", "Magic Bomb (Ver. NB6.1, 26/04/04)",             MACHINE_SUPPORTS_SAVE | MACHINE_NOT_WORKING,           layout_magibomb  ) // 26/04/04. Undumped sprite ROM
