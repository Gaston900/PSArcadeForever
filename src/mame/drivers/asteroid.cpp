...
static INPUT_PORTS_START( asteroid )
	...
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON5 ) PORT_CODE(KEYCODE_D) PORT_CODE(JOYCODE_BUTTON3)       // Hyperspace
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 ) PORT_CODE(KEYCODE_S) PORT_CODE(JOYCODE_BUTTON1)    // Fire
	...
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON4 ) PORT_CODE(KEYCODE_A) PORT_CODE(JOYCODE_BUTTON2)        // Thrust
...
static INPUT_PORTS_START( asteroidb )
	...
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON4 ) PORT_CODE(KEYCODE_A) PORT_CODE(JOYCODE_BUTTON2)            // Thrust
	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_COIN2 )
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON3 ) PORT_CODE(KEYCODE_S) PORT_CODE(JOYCODE_BUTTON1)        // Fire
	...
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_CODE(KEYCODE_D) PORT_CODE(JOYCODE_BUTTON3)            // Hyperspace
INPUT_PORTS_END
...
static INPUT_PORTS_START( asterock )
	...
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_CODE(KEYCODE_D) PORT_CODE(JOYCODE_BUTTON3)        // Hyperspace
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_CODE(KEYCODE_S) PORT_CODE(JOYCODE_BUTTON1)     // Fire
