...
ROM_START( cupsocsb5 )
	...
	ROM_REGION( 0x100000, "gfx4", ROMREGION_INVERT )
	ROM_COPY( "gfx3", 0x00000, 0x00000, 0x100000 )

	ROM_REGION( 0x080000, "gfx5", ROMREGION_INVERT )
	ROM_COPY( "test1", 0x180000, 0x00000, 0x080000 )

	ROM_REGION( 0x080000, "gfx6", ROMREGION_INVERT )
	ROM_COPY( "gfx5", 0x00000, 0x00000, 0x080000 )
