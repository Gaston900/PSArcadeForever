...
INPUT_PORTS_START( pgm )
	...
	PORT_BIT( 0x0060, IP_ACTIVE_LOW, IPT_BUTTON_AB ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button2)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x0060)	
	PORT_BIT( 0x00A0, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button3)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x00A0)
	PORT_BIT( 0x00C0, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button2 + Button3)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x00C0)
	PORT_BIT( 0x00E0, IP_ACTIVE_LOW, IPT_BUTTON_ABC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button1 + Button2 + Button3)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x00E0)
	...
	PORT_BIT( 0x6000, IP_ACTIVE_LOW, IPT_BUTTON_AB ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button2)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0x6000)	
	PORT_BIT( 0xA000, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button3)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0xA000)
	PORT_BIT( 0xC000, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button2 + Button3)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0xC000)
	PORT_BIT( 0xE000, IP_ACTIVE_LOW, IPT_BUTTON_ABC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button1 + Button2 + Button3)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0xE000)
