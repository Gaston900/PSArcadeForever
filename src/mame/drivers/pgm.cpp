...
INPUT_PORTS_START( pgm )
	...
	PORT_BIT( 0x00A0, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button 1 + Button 3)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x00A0)
	PORT_BIT( 0x00C0, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(1) PORT_NAME("P1 Button Combokey (Button 2 + Button 3)") PORT_CONDITION("P1P2", 0x00F0, NOTEQUALS, 0x00C0)
	...
	PORT_BIT( 0xA000, IP_ACTIVE_LOW, IPT_BUTTON_AC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button 1 + Button 3)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0xA000)
	PORT_BIT( 0xC000, IP_ACTIVE_LOW, IPT_BUTTON_BC ) PORT_PLAYER(2) PORT_NAME("P2 Button Combokey (Button 2 + Button 3)") PORT_CONDITION("P1P2", 0xF000, NOTEQUALS, 0xC000)
