...
ROM_START( bloxeedbl )
	...
	ROM_REGION( 0x30000, "gfx1", ROMREGION_INVERT ) // 2 ROMs verified same as original but with inverted bits. One ROM was dead and was recreated from the original for now.
